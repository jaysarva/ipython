...
class AutoreloadMagics(Magics):
    ...
    def post_execute_hook(self):
        ...
        if self._reloader.enabled and self._reloader.autoload_obj:
            ...
            if hasattr(self, '_last_execution_info') and self._last_execution_info and self._last_execution_info.raw_cell:
                self._track_imports_from_code(self._last_execution_info.raw_cell)
            ...
            for node in ast.walk(tree):
                ...
                if isinstance(node, ast.ImportFrom):
                    ...
                    for name in node.names:
                        ...
                        self._reloader.import_from_tracker.add_import(mod, original_name, resolved_name)
