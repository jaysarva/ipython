...
""",
    ...
    def test_import_from_tracker_unloaded_module(self):
        ...
        assert "some_attr" not in tracker.imports_froms[fake_mod_name]  # Should be replaced
        assert tracker.symbol_map[fake_mod_name]["another_attr"] == "some_name"
        assert "some_attr" not in tracker.symbol_map[fake_mod_name]  # Should be replaced
